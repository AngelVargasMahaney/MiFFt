...
export const getOfertas = async (id) => {
  const rpta = await axios.get(`${URL_MOCKAPI}/oferta/${id}`)
  return rpta
}
export const getOfertasTodas = async()=>{
  const rpta = await axios.get(`${URL_MOCKAPI}/oferta`)
  return rpta
}

export const getEmpleadoById = async (id) => {
  const rpta = await axios.get(`${URL_MOCKAPI}/empleado/${id}`)
  return rpta
}
